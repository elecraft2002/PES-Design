 ...
 *
 */
type PageDocumentDataSlicesSlice = ImageSlice | QuoteSlice | TextSlice | ContactFormSlice | BigTextSlice | SmallTextSlice | ProjectsSlice;
/**
 ...
 *
 */
type ProjectDocumentDataSlicesSlice = ImageSlice | SmallTextSlice | ProjectsSlice | TextSlice | BigTextSlice;
/**
...
interface SettingsDocumentData {
    ...
    /**
     * Mobile field in *Settings*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: settings.mobile
     * - **Tab**: Main
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
...
interface BigTextSliceDefaultPrimary {
    /**
     * Title field in *BigText → Primary*
     *
     * - **Field Type**: Title
     * - **Placeholder**: This is where it all begins...
     * - **API ID Path**: big_text.primary.title
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    title: prismicT.TitleField;
    /**
     * Link field in *BigText → Primary*
     *
     * - **Field Type**: Link
     * - **Placeholder**: *None*
     * - **API ID Path**: big_text.primary.link
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
    link: prismicT.LinkField;
    /**
     * Background media field in *BigText → Primary*
     *
     * - **Field Type**: Link to Media
     * - **Placeholder**: *None*
     * - **API ID Path**: big_text.primary.background_media
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
    background_media: prismicT.LinkToMediaField;
}
/**
...
/**
 * Primary content in SmallText → Primary
 *
 */
interface SmallTextSliceDefaultPrimary {
    /**
     * Title field in *SmallText → Primary*
     *
     * - **Field Type**: Title
     * - **Placeholder**: This is where it all begins...
     * - **API ID Path**: small_text.primary.title
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    title: prismicT.TitleField;
    /**
     * Description field in *SmallText → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: small_text.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
 ...
 *
 */
export type SmallTextSliceDefault = prismicT.SharedSliceVariation<"default", Simplify<SmallTextSliceDefaultPrimary>, never>;
/**
 ...
 *
 */
export type SmallTextSlice = prismicT.SharedSlice<"small_text", SmallTextSliceVariation>;
/**
